...
const EditAiSetting = () => {
  ...
  const isFreeUser = auth.currentUser.type_of_account.getType() === "Free";

  const formik = useFormik({
    initialValues: initialValue,
    validationSchema: Yup.object().shape({
      Description: Yup.string()
        .required("You have entered 0/500")
        .min(500)
        .max(
          isFreeUser ? 2000 : Infinity,
          `Maximum 2000 characters allowed for free users`
        ),
    }),
    onSubmit: (values) => {
      console.log(values);
        ...
        <p className="text-[14px]" key={index}>
          {parts.map((part, i) => {
            if (part.startsWith("**") && part.endsWith("**")) {
              ...
              return (
                <strong className="text-[16px]" key={i}>
                  {part.slice(2, -2)}
                </strong>
              );
            } else {
    ...
    <>
      ...
      >
        ...
        {showLearnMore && (
          <div className=" top-0 left-0 w-full bg-white min-h-screen absolute z-40">
            <div className="flex  w-full items-center justify-between px-6 mt-[80px] ">
              ...
              <div className="text-[16px] font-semibold text-text-primary">
                Learn more about your AI settings
              </div>
              <Button
                onClick={() => {
              ...
              <div className="text-left my-4" style={{ lineHeight: "28px" }}>
                ...
                <div className="text-justify text-[14px]" style={{}}>
                  <p className={" text-[16px]"}>
                    Avatalk's AI Knowledge section is the hub for crafting a
                    personalized and effective AI-driven persona. This feature
                    ensures your digital interactions reflect your unique
                    professional expertise, style, and preferences, enhancing
                    your presence and effectiveness across virtual platforms.
                  </p>
                  <h1 className={"font-bold text-[16px]"}>
                    Purpose of Customizing Your AI Knowledge
                  </h1>

                  <p className={" text-[16px]"}>
                    The core of Avatalk's appeal lies in its ability to let you
                    tailor your AI's knowledge base, which in turn shapes how
                    your digital persona interacts in professional settings.
                    Whether it’s for virtual networking, engaging potential
                    clients, or maintaining an active professional online
                    presence, the information you feed into your AI helps it
                    deliver insightful, relevant responses. This customization
                    aligns your AI's interactions with your personal and
                    professional ambitions, helping you stand out in a
                  ...
                  <p className={" text-[16px]"}>
                    Navigate to the "AI Settings" in Avatalk to start
                    customizing:
                  </p>

                  <ul>
                    <li className={"list-disc text-[16px] ml-10 pl-3"}>
                      <span className={"font-bold"}>AI Knowledge Input:</span>{" "}
                      Use the rich text editor to enter details about your
                      professional domain, expertise, and other pertinent
                      information you wish your AI to communicate. The more
                      detailed and specific your input, the more accurately and
                      effectively your AI represents you.
                    </li>
                    ...
                    <li className={"list-disc text-[16px] ml-10 pl-3"}>
                      ...
                      Choose your AI persona's voice gender from a dropdown menu
                      to match your professional identity, reinforcing the
                      consistency of your digital persona.
                    </li>

                    <li className={"list-disc text-[16px] ml-10 pl-3"}>
                      <span className={"font-bold"}>Analyze by AI:</span> This
                      functionality analyzes your inputs and suggests
                      enhancements to increase clarity and engagement, ensuring
                      your AI persona communicates with sophistication and
                      professionalism.
                    </li>

                    <li className={"list-disc text-[16px] ml-10 pl-3"}>
                      <span className={"font-bold"}>Saving Changes:</span> After
                      tweaking your AI's knowledge and voice settings, click
                      "Save Changes" to implement them. Your AI will instantly
                      use this updated information, ensuring your digital
                      presence remains polished and precise.
                    </li>
                  </ul>
                  ...
                  <p className={" text-[16px]"}>
                    While the free version of Avatalk offers substantial
                    benefits, upgrading to the Pro version unlocks unlimited
                    edits and continuous refinements of your AI persona. This
                    allows for ongoing adjustments as your professional needs
                    evolve, giving you the flexibility to keep your digital
                    persona as dynamic and responsive as your career itself.
                  </p>

                  <h1 className={"font-bold  text-[16px]"}>
                    Maximize Your AI Knowledge for Effective Networking
                  </h1>

                  <p className={" text-[16px]"}>
                    With Avatalk’s intuitive design, you can readily update and
                    refine your AI settings, ensuring your persona remains
                    relevant and impactful in all professional interactions.
                    Leverage the full capabilities of Avatalk by upgrading to
                    the Pro version, where the possibilities for customizing and
                    enhancing your AI-driven persona are limitless, ensuring
                    you're always ready to make meaningful professional
                    connections.
                  </p>
                </div>
              </div>
        ...
        >
          <div className="px-6">
            <AccessNotifManager
              isLimited={auth.currentUser.editStatus}
              page="AiSetting"
            ></AccessNotifManager>
          </div>
          <div className="px-6 mt-2">
            <div className="text-base  mb-4 text-justify text-text-primary">
              ...
              <span
                className="text-[#06B6D4] ml-1 cursor-pointer"
                onClick={() => {
            ...
            <TextArea
              ...
              setAnalysedText={setAnaysedText}
              setShowSuggestion={setShowAiSuggestion}
          ...
          <div className="px-6 mt-4">
            ...
            >
              <div
                className="cursor-pointer h-10 flex items-center justify-start px-4"
                onClick={() => {
                  setGender("male");
                }}
              >
          ...
          <div className="px-6 mt-5">
            <Button
              data-os={getOS}
              disabled={
                !formik.isValid || formik.values.Description.length == 0
              }
              onClick={() => {
                if (
                  auth.currentUser.type_of_account.getType() == "Free" &&
                  auth.currentUser.editStatus
                ) {
                  setIsReadyTo(true);
                } else {
          ...
          <video onEnded={handleVideoEnd}  ref={videoRef} src={'https://newcodieblob.blob.core.windows.net/avatalk/Videos/tut_1.mp4'} style={{display:isVisible?'block':'none'}} />
