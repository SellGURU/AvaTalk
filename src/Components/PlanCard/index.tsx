  ...
  return (
    <>
      <div className="w-full h-[230px] pt-4 px-6 relative bg-primary-color rounded-[24px] flex flex-col items-center justify-start ">
        <img
          className={"w-[50px] relative z-50 h-[50px]"}
          src={"/Carbon/L-Shield Done.svg"}
        />
        <img
          width={32}
          height={32}
          className=" absolute right-2 top-3 w-8 h-8 cursor-pointer  z-[100] "
          src="/icons/Add.svg"
          onClick={onClose}
          alt=""
        />
        <div className=" overflow-hidden  rounded-3xl h-full  absolute  w-full opacity-100 left-0 bottom-0 right-0 top-0">
          <img
            className="w-full scale-150 h-full rounded-xl "
            src="/icons/backPlanBg.svg"
            alt=""
          />
        </div>
        ...
        <div className=" w-full flex   mt-3">
          <div style={{textAlignLast: "center"}} className="text-white text-[14px]  text-justify relative z-50   w-full">
            Unlock the full potential of this app and elevate your networking
  ...
  return (
    <>
      <div className="w-full pt-4 px-6 overflow-hidden h-[232px] relative bg-primary-color rounded-[24px] flex flex-col justify-start items-center">
        ...
        <div className="pt-2 w-full flex items-center justify-center"></div>
        <div className=" w-full mt-3 text-center flex flex-col  ">
          <div style={{textAlignLast: "center"}} className="text-white text-[14px] text-justify  w-full  relative z-50   ">
        ...
        <div className=" w-full  flex flex-col items-center justify-center gap-2">
          ...
          >
            <div
              ...
              style={{
                background:
                  "linear-gradient(to right, #FECA06 50%, #FECA06 100%)",
                width: `${auth.currentUser.type_of_account.getPercentDayUsed()}%`,
              }}
            ></div>
          </div>
          <div className="text-[#F9FAFB] text-sm font-medium self-start ">
            {" "}
            {auth.currentUser.type_of_account.getDayUsed()}/14 Day
          </div>
        </div>
        <div
          onClick={() => {
    ...
    <>
      <div className="w-full pt-4 px-6 h-[232px] relative bg-primary-color rounded-[24px] flex flex-col justify-start items-center">
        ...
        <div className="w-full text-center mt-3">
          <div style={{textAlignLast: "center"}} className="text-white text-[14px] text-justify relative z-50   w-full">
            {auth.currentUser.type_of_account.getDayremindToExpired()} days
            left! Renew now to keep enjoying premium networking tools without
            interruption.
          </div>
        </div>
        <div className=" w-full  flex flex-col items-center justify-center gap-2">
          ...
          <div className="text-[#F9FAFB] text-sm font-medium self-start ">
            {" "}
            {auth.currentUser.type_of_account.getDayremindToExpiredFrom7Day()}/7
            Day
          </div>
        </div>
        <div
