...
const ExchangeContact: React.FC<ExchangeContactProps> = ({
  onClose,
  fullName,
  mode,
  userId,
  ...
  return (
    <>
      <div
        ref={ShowProfileRef}
        className="rounded-[27px] px-6 py-6 max-w-[32rem] h-[93svh] max-h-[678px] pb-10 rounded-b-none slideupModal  bg-white w-full"
      >
        {step == 0 ? (
          <>
            <div className="flex w-full justify-between items-start">
              ...
              <div className="flex-grow text-center">
                <div className="text-text-primary text-[14px] font-semibold w-full contactNameShadow">
                  Share your contact info with
                </div>
                <div className="w-full flex items-center justify-center">
                  <div className="text-text-primary break-words text-center text-xs w-[80%]">
                    {fullName}
                  </div>
                </div>
              </div>
            ...
            <div className="w-full overflow-y-scroll mt-4 hiddenScrollBar h-[85vh]">
              ...
              <div className="mt-10">
                ...
                <div className="text-[12px] text-[#6B7280] text-center mt-2 mb-5">
          ...
          <>
            <div>
              ...
              <div className="text-[14px] font-medium mt-6 text-center text-text-primary">
                Keep the momentum going—create your Avatalk in minutes with our
                free trial."
              </div>
              <div className="w-full flex justify-center mt-5">
                <div className="w-[240px] h-[368px] bg-primary-color rounded-[30px]">
                  ...
                  <div>
                    <div className="text-white text-[18px] font-semibold overflow-hidden text-nowrap text-ellipsis  text-center">
                      {formik.values.fullName}
                    </div>
