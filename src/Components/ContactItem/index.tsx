        ...
        <div className={`${theme}-ContactItem-card `}>
          <div className={`${theme}-ContactItem-innerCard `}>
            ...
            <div className={`${theme}-ContactItem-iconContainer  `}>
              {data.tags.length == 1 && <p className={`${theme}-ContactItem-exhibition overflow-x-hidden `} style={{backgroundColor:data.tags[0].color,color:getTextColorFromBackground(data.tags[0].color)}}>{data.tags[0].name}</p>}
              {data.tags.length > 1 ?
