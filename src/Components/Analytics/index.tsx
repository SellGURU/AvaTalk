    ...
    <div className={`${theme}-Analytics-container `}>
      ...
      <div className={`${theme}-Analytics-divider2`}>
        {data.length > 0 ? (
          <AreaChartComponent
            data={
              data.filter((item) => item.name == "Page Views")[0].value.data
            }
            theme={theme}
          />
        ) : (
      ...
      <div className={`${theme}-Analytics-divider2`}>
        {data.length > 0 ? (
          <PiChartComponent
            chartData={
              data.filter((el) => el.name == "Types of Views")[0].value.data
            }
            theme={theme}
          />
        ) : (
      ...
      <div className="mb-2 pb-4">
        {data.length > 0 ? (
          <BarChartComponent
            data={
              data.filter((el) => el.name == "Clicks per Category")[0].value
                .data
            }
            theme={theme}
          />
