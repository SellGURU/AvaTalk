    ...
    <div className={`${theme}-AnalyticsSummary-container`}>
      <div className={`${theme}-AnalyticsSummary-rowContainer`}>
        <div className={`${theme}-AnalyticsSummary-cardContainer relative`}>
          ...
          <p className={`${theme}-AnalyticsSummary-number ${isVisible?'opacity-100':'opacity-45 blur-[4px]'}`}>
            {data.length >0 ?
        ...
        <div className={`${theme}-AnalyticsSummary-cardContainer relative`}>
          ...
          <p className={`${theme}-AnalyticsSummary-number ${isVisible?'opacity-100':'opacity-45 blur-[4px]'}`}>{data.length> 0? data.filter(el => el.name == 'َAR Usage')[0].value:'0'}</p>
          {
            !isVisible &&
            <div className="w-full h-full bg-[#5B21B626] absolute z-30 rounded-[25px] left-0 top-0"></div>
          }
        ...
        <div className={`${theme}-AnalyticsSummary-cardContainer relative`}>
          ...
          <p className={`${theme}-AnalyticsSummary-number ${isVisible?'opacity-100':'opacity-45 blur-[4px]'}`}>{data.length> 0?data.filter(el => el.name == 'Chat Count')[0].value:'0'}</p>
          {
            !isVisible &&
            <div className="w-full h-full bg-[#5B21B626] absolute z-30 rounded-[25px] left-0 top-0"></div>
          }
      ...
      <div className={`${theme}-AnalyticsSummary-rowContainer`}>
        <div className={`${theme}-AnalyticsSummary-cardContainer relative`}>
          ...
          <p className={`${theme}-AnalyticsSummary-number ${isVisible?'opacity-100':'opacity-45 blur-[4px]'}`}>{data.length> 0?data.filter(el => el.name == 'Save Contact')[0].value:'0'}</p>
          {
            !isVisible &&
            <div className="w-full h-full bg-[#5B21B626] absolute z-30 rounded-[25px] left-0 top-0"></div>
          }
        ...
        <div className={`${theme}-AnalyticsSummary-cardContainer relative`}>
          ...
          <p className={`${theme}-AnalyticsSummary-number ${isVisible?'opacity-100':'opacity-5 opacity-45 blur-[4px]'}`}>{data.length> 0?data.filter(el => el.name == 'Link Click')[0].value:'0'}</p>
          {
            !isVisible &&
            <div className="w-full h-full bg-[#5B21B626] absolute z-30 rounded-[25px] left-0 top-0"></div>
          }
        ...
        <div className={`${theme}-AnalyticsSummary-cardContainer relative`}>
          ...
          <p className={`${theme}-AnalyticsSummary-number ${isVisible?'opacity-100':'opacity-5 opacity-45 blur-[4px]'}`}>{data.length> 0?data.filter(el => el.name == 'File Click')[0].value:'0'}</p>
          {
            !isVisible &&
            <div className="w-full h-full bg-[#5B21B626] absolute z-30 rounded-[25px] left-0 top-0"></div>
          }
